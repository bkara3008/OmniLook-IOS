...
class PaymentDetailSectionView: UITableViewHeaderFooterView {
    // MARK: - Lifecycle -
    ...
    func configure(title: String, totalAccount: String, amount: String, isExpand: Bool){
        self.paymentName.text = title
        self.amount.text = amount
        self.accountAmount.text = totalAccount
    ...
    private lazy var titlesContainerView: UIStackView = {
        let stackView = UIStackView(arrangedSubviews: [self.paymentName,
                                                       self.accountAmount,
                                                       self.amount])
    ...
    private lazy var paymentName: UILabel = {
        let label = UILabel()
    ...
    private lazy var accountAmount: UILabel = {
        let label = UILabel()
        label.font = UIFont(name: "Montserrat-Bold", size: 14)
        label.textColor = .white
