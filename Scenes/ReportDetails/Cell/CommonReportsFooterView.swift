...
class CommonReportsFooterView: UITableViewHeaderFooterView {
    // MARK: - Lifecycle -
    ...
    func configure(totalAmount: String) {
        self.totalAmountLabel.text = totalAmount
        self.TotalTitle.text = "TOTAL".translated()
    }
